...
export default function About() {
  const skillsByCategory = about.technical.skills.reduce<Record<string, typeof about.technical.skills>>(
    (categories, skill) => {
      categories[skill.category] = [...(categories[skill.category] || []), skill];
      return categories;
    },
    {},
  );
            ...
            <>
              ...
              <Column fillWidth gap="xl">
                {Object.entries(skillsByCategory).map(([category, skills]) => (
                  <Column key={category} fillWidth gap="m">
                    <Heading as="h3" variant="heading-strong-m">{category}</Heading>
